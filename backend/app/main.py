...
async def startup():
    ...
    # primer visitante no paga el build frío (~minutos). El loop ancla cada
    # re-warmup al vencimiento del cache (gen+TTL, piso 60s) para que ningún
    # request alcance un contexto expirado (fix criterio 2, 2026-09-10).
