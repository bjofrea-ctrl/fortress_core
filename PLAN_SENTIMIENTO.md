...
| Pendientes de auditoría (no bloqueantes) | n_eff=36 en OOS 60d (confirmación ajustada); **RÉGIMEN HMM AUDITADO 2026-08-10 (0a)**: veredicto en `data/cache/regime_audit_20260810_082318.txt` — deterioro G1 OOS transversal (REFLATION 60d -0.29, STAGFLATION 60d -0.42***), NO explicable por régimen anómalo nuevo (los 2 regímenes OOS estaban en IS); V1 conserva signo positivo OOS en ambos (60d: +0.23 / +0.32) → refuerza la integración como diversificador por régimen. Sigue pendiente: Fase 0b (backtest con costos sobre universo real) |
