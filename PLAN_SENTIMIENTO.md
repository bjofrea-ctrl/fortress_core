...
| Pendientes de auditoría (no bloqueantes) | n_eff=36 en OOS 60d (confirmación ajustada); **0a régimen HMM ✅ 2026-08-10** (`data/cache/regime_audit_20260810_082318.txt`): deterioro G1 OOS transversal, no por régimen; V1 positiva OOS por régimen. **0b backtest con costos ✅ 2026-08-10** (`data/cache/backtest_v1_costs_20260810_083449.txt`): baseline sin edge neto (DSR p=0.118); V1 bloquea todo por escala (blend ≤ 0.5 < gate 0.6, matemático) → **decisión de diseño pendiente del usuario** (3 opciones en veredicto: señal centrada [0,1]+gate, blend solo-ranking §7, modulador de riesgo) |
