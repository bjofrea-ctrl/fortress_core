...
| Pendientes de auditoría (no bloqueantes) | n_eff=36 en OOS 60d (confirmación ajustada); **0a régimen HMM ✅ 2026-08-10** (`data/cache/regime_audit_20260810_082318.txt`): deterioro G1 OOS transversal, no por régimen; V1 positiva OOS por régimen. **0b backtest con costos ✅ (2 corridas)** (`data/cache/backtest_v1_costs_20260810_083449.txt` v1-gate bloqueo matemático; `backtest_v1_costs_20260810_091011.txt` v2-ranking H7): V1-ranking Sharpe 0.07→0.17 full pero **OOS -0.60→-0.72 (empeora)**, DSR p=0.164 (trial #8) → **sin edge neto demostrable; V1 no crea rentabilidad con costos; NO más variantes de V1 sin evidencia nueva**. Siguiente: Fase 1 fundamentales QC |
